...
public class GUI extends JComponent {
    ...
    public GUI(Problem problem) {
        ...
        menuPanel.add(resetButtonMaker(problem));
     ...
     */
    private JButton moveButtonMaker(final Move move, final Problem problem) {
     ...
     */
    private JButton resetButtonMaker(final Problem problem)
    {
        JButton newButton = new JButton();
     ...
     * @param problem.  Current Problem for the GUI.
     */    
    private void resetGame(final Problem problem) {
    ...
    private void winGame(final Problem problem) {
     ...
     /**
     * Data member for the text state container.  Global to the class so that it
     * can be modified by various buttons.
     */
    final private JTextArea textState;
     /**
     * Data constant holding the starting state for resetting.
     */
    final private State STARTINGSTATE;
     /**
     * An arrray of buttons to quickly enable and disable them.
     */
