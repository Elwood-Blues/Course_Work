...
public class GUI extends JComponent {
    ...
    public GUI(Problem problem, Canvas canvas) {
        ...
        solverPanel.setLayout(new GridLayout(3,1));
        ...
        ChangeListener changeListener = new ChangeListener() {
            public void stateChanged(ChangeEvent changEvent) {
                if (radioDepth.isSelected()) isDepthFirst = true;
                else isDepthFirst = false;
            }
        };
        ...
        JLabel labelNumDequeOps = new JLabel("Number of DEQUE Ops: ");
        JLabel labelMaxDeque = new JLabel("Max Deque Size: ");
     ...
     */
    private void showAllMovesButtonMaker(final JButton button)
    {
