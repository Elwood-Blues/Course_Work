...
public class BridgeCanvas extends Canvas{
    ...
    /**
     * Alternate constructor for a scaled instance of canvas
     * Constructs the water jug state
     * @param initState: the initial water jug state
     * @param scale : the scaled size(300 default)
     */
    public BridgeCanvas (State initState, Integer scale){
        super(initState);
