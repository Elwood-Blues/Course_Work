...
//        setCurrentState(tempBridgeState);
        ...
        startStates.add(new BridgeState(Position.WEST, Position.WEST, Position.WEST, Position.WEST, Position.WEST, 0));
        super.setStartingStates(startStates);
        
        List<State> solnStates = new ArrayList<State>();
        solnStates.add(new BridgeState(Position.EAST, Position.EAST, Position.EAST, Position.EAST, Position.EAST, 17));
