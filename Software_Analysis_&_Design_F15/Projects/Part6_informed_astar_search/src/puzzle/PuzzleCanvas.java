...
public class PuzzleCanvas extends Canvas{
    ...
    public PuzzleCanvas (State initState, int scale){
        super(initState);
    ...
    public void paintComponent(Graphics g) {
        ...
        g2.setFont(new Font("Sans-Serif",Font.BOLD,36));
        
        
        int txXStart = XSTART + XSCALE/2 - 10;
        int txYStart = YSTART + YSCALE/2 + 12;
