...
Vector3D Vector3D::normalize() {
    ...
    if(length == 0)
        ...
        return Vector3D(this->v3Array[0]/=length, v3Array[1] /= length, v3Array[2]/=length);
    }

}

double Vector3D::magnitude() {
    return sqrt(pow(this->v3Array[0], 2.0) + pow(this->v3Array[1], 2.0) + pow(this->v3Array[2],2.0));
}
